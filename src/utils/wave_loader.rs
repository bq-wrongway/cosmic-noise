//! Show a wave loading indicator with pause/resume.
...
pub struct WaveLoading<'a, Theme>
where
    Theme: StyleSheet,
{
    width: Length,
...
impl<'a, Theme> WaveLoading<'a, Theme>
where
    Theme: StyleSheet,
{
    pub fn new() -> Self {
...
impl<Theme> Default for WaveLoading<'_, Theme>
where
    Theme: StyleSheet,
{
    fn default() -> Self {
...
impl<'a, Message, Theme, Renderer> From<WaveLoading<'a, Theme>>
...
{
    fn from(wave: WaveLoading<'a, Theme>) -> Self {
        Self::new(wave)
    }
}
